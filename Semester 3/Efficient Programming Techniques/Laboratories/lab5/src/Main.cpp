...
int main() {
    ...
    std::cout << "Counter after ptr1 creation: " << ptr1.getCounter() << std::endl;
    ...
    std::cout << "Counter after ptr2 creation: " << ptr1.getCounter() << std::endl;
    std::cout << "Counter after ptr2 creation: " << ptr2.getCounter() << std::endl;

    // Creating a third smart pointer using the duplicate method
    MySmartPointer<Test> ptr3 = ptr1.duplicate();
    std::cout << "Counter after ptr3 creation: " << ptr1.getCounter() << std::endl;
    std::cout << "Counter after ptr3 creation: " << ptr3.getCounter() << std::endl;
