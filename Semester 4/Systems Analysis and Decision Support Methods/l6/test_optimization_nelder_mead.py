...
from optimization_nelder_mead import rosenbrock_function, shrink, contract, expand, reflect, run_nelder_mead, Simplex2D
...
def test_reflect_incorrect_alpha_value(point, centroid, alpha):
    ...
    assert "Invalid value of alpha parameter. Alpha must be greater than 0!" in str(excinfo.value)
...
def test_expand_incorrect_gamma_value(point, centroid, gamma):
    ...
    assert "Invalid value of gamma parameter. Gamma must be greater than 1!" in str(excinfo.value)
...
def test_contract_incorrect_beta_value(point, centroid, beta):
    ...
    assert "Invalid value of beta parameter. Beta must be in range (0,1)!" in str(excinfo.value)
...
def test_shrink_incorrect_sigma_value(simplex, sigma):
    ...
    assert "Invalid value of sigma parameter. Sigma must be in range (0,1)!" in str(excinfo.value)
